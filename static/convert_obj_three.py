    ...
    for line in fileinput.input(fname):
        ...
        if len(chunks) > 0:
            ...
            if chunks[0] == "Kd" and len(chunks) == 4:
                ...
                if float(chunks[1]) == 0 or float(chunks[2]) == 0 or float(chunks[3]) == 0:
                    materials[identifier]["colorDiffuse"] = [0.64, 0.64, 0.64]
            ...
            if chunks[0] == "Ks" and len(chunks) == 4:
                ...
                if float(chunks[1]) == 0 or float(chunks[2]) == 0 or float(chunks[3]) == 0:
                    materials[identifier]["colorSpecular"] = [0.64, 0.64, 0.64]
